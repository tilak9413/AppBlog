...
import CaseStudiesAndConnect from "./CaseStudiesAndConnect";
    ...
    return (
        <>
            ...
            <main className="w-full px-6 md:px-16">
                ...
                <motion.div {...fadeIn(0.2)}><WhyChooseUsSection /></motion.div>
                <motion.div {...fadeIn(0.2)}><HowItWorksSection /></motion.div>
                <motion.div {...fadeIn(0.2)}><IndustriesSection /></motion.div>
                <motion.div {...fadeIn(0.2)}><JoinTeamSection /></motion.div>
                <motion.div {...fadeIn(0.2)}><BlogSection /></motion.div>
                <motion.div {...fadeIn(0.2)}><CaseStudiesAndConnect /></motion.div>
            </main>
        </>
    );
}
